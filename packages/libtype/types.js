...
export const common = $root.common = (() => {
    ...
    common.Message = (function() {
        ...
        Message.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Message)
                return object;
    ...
    common.Usage = (function() {
        ...
        Usage.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.prompt_tokens != null && message.hasOwnProperty("prompt_tokens"))
                if (!$util.isInteger(message.prompt_tokens))
                    return "prompt_tokens: integer expected";
            if (message.completion_tokens != null && message.hasOwnProperty("completion_tokens"))
                if (!$util.isInteger(message.completion_tokens))
                    return "completion_tokens: integer expected";
            if (message.total_tokens != null && message.hasOwnProperty("total_tokens"))
        ...
        Usage.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Usage)
                return object;
    ...
    common.Choice = (function() {
        ...
        Choice.verify = function verify(message) {
            ...
            if (message.finish_reason != null && message.hasOwnProperty("finish_reason")) {
        ...
        Choice.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Choice)
                return object;
        ...
        Choice.toObject = function toObject(message, options) {
            ...
            if (message.message != null && message.hasOwnProperty("message"))
                object.message = $root.common.Message.toObject(message.message, options);
            if (message.finish_reason != null && message.hasOwnProperty("finish_reason")) {
                object.finish_reason = message.finish_reason;
                if (options.oneofs)
                    object._finish_reason = "finish_reason";
            }
            return object;
        };
    ...
    common.Embedding = (function() {
        ...
        Embedding.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Embedding)
                return object;
        ...
        Embedding.toObject = function toObject(message, options) {
            ...
            if (message.embedding && message.embedding.length) {
                ...
                for (let j = 0; j < message.embedding.length; ++j)
                    object.embedding[j] = options.json && !isFinite(message.embedding[j]) ? String(message.embedding[j]) : message.embedding[j];
            }
            return object;
        };
    ...
    common.Chunk = (function() {
        ...
        Chunk.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Chunk)
                return object;
    ...
    common.Similarity = (function() {
        ...
        Similarity.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Similarity)
                return object;
    ...
    common.Prompt = (function() {
        ...
        Prompt.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.system_instructions != null && message.hasOwnProperty("system_instructions")) {
            ...
            if (message.previous_similarities != null && message.hasOwnProperty("previous_similarities")) {
                ...
                for (let i = 0; i < message.previous_similarities.length; ++i) {
                    let error = $root.common.Similarity.verify(message.previous_similarities[i]);
                    if (error)
                        return "previous_similarities." + error;
                }
            }
            if (message.current_similarities != null && message.hasOwnProperty("current_similarities")) {
                ...
                for (let i = 0; i < message.current_similarities.length; ++i) {
                    let error = $root.common.Similarity.verify(message.current_similarities[i]);
                    if (error)
                        return "current_similarities." + error;
                }
            }
        ...
        Prompt.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Prompt)
                return object;
            ...
            if (object.system_instructions) {
                ...
                for (let i = 0; i < object.system_instructions.length; ++i)
                    message.system_instructions[i] = String(object.system_instructions[i]);
            }
            if (object.previous_similarities) {
                if (!Array.isArray(object.previous_similarities))
                    throw TypeError(".common.Prompt.previous_similarities: array expected");
                ...
                for (let i = 0; i < object.previous_similarities.length; ++i) {
                    if (typeof object.previous_similarities[i] !== "object")
                        throw TypeError(".common.Prompt.previous_similarities: object expected");
                    message.previous_similarities[i] = $root.common.Similarity.fromObject(object.previous_similarities[i]);
                }
            }
            if (object.current_similarities) {
                if (!Array.isArray(object.current_similarities))
                    throw TypeError(".common.Prompt.current_similarities: array expected");
                ...
                for (let i = 0; i < object.current_similarities.length; ++i) {
                    if (typeof object.current_similarities[i] !== "object")
                        throw TypeError(".common.Prompt.current_similarities: object expected");
                    message.current_similarities[i] = $root.common.Similarity.fromObject(object.current_similarities[i]);
                }
            }
            if (object.messages) {
                ...
                for (let i = 0; i < object.messages.length; ++i) {
                    ...
                    message.messages[i] = $root.common.Message.fromObject(object.messages[i]);
                }
            }
            return message;
        };
        ...
        Prompt.toObject = function toObject(message, options) {
            ...
            if (message.previous_similarities && message.previous_similarities.length) {
                object.previous_similarities = [];
                for (let j = 0; j < message.previous_similarities.length; ++j)
                    object.previous_similarities[j] = $root.common.Similarity.toObject(message.previous_similarities[j], options);
            }
            if (message.current_similarities && message.current_similarities.length) {
                object.current_similarities = [];
                for (let j = 0; j < message.current_similarities.length; ++j)
                    object.current_similarities[j] = $root.common.Similarity.toObject(message.current_similarities[j], options);
            }
            if (message.messages && message.messages.length) {
                object.messages = [];
                for (let j = 0; j < message.messages.length; ++j)
                    object.messages[j] = $root.common.Message.toObject(message.messages[j], options);
            }
            return object;
        };
    ...
    common.Resource = (function() {
         ...
         * @property {Array.<string>|null} [purpose] Resource purpose
         * @property {Array.<string>|null} [instructions] Resource instructions
         * @property {Array.<string>|null} [applicability] Resource applicability
         * @property {Array.<string>|null} [evaluation] Resource evaluation
         * @property {number|null} [tokens] Resource tokens
         * @property {number|null} [magnitude] Resource magnitude
        ...
        /**
         * Resource purpose.
         * @member {Array.<string>} purpose
         * @memberof common.Resource
         * @instance
         */
        Resource.prototype.purpose = $util.emptyArray;
         ...
         * @instance
         */
        Resource.prototype.instructions = $util.emptyArray;

        /**
         * Resource applicability.
         * @member {Array.<string>} applicability
         * @memberof common.Resource
         * @instance
         */
        Resource.prototype.applicability = $util.emptyArray;

        /**
         * Resource evaluation.
         * @member {Array.<string>} evaluation
         * @memberof common.Resource
         * @instance
         */
        Resource.prototype.evaluation = $util.emptyArray;
         ...
         * @instance
         */
        Resource.prototype.magnitude = null;
         ...
         * @instance
         */
        Object.defineProperty(Resource.prototype, "_magnitude", {
        ...
        Resource.verify = function verify(message) {
            ...
            if (message.purpose != null && message.hasOwnProperty("purpose")) {
                ...
                for (let i = 0; i < message.purpose.length; ++i)
                    if (!$util.isString(message.purpose[i]))
            ...
            if (message.applicability != null && message.hasOwnProperty("applicability")) {
                if (!Array.isArray(message.applicability))
                    return "applicability: array expected";
                for (let i = 0; i < message.applicability.length; ++i)
                    if (!$util.isString(message.applicability[i]))
                        return "applicability: string[] expected";
            }
            if (message.evaluation != null && message.hasOwnProperty("evaluation")) {
                if (!Array.isArray(message.evaluation))
                    return "evaluation: array expected";
                for (let i = 0; i < message.evaluation.length; ++i)
                    if (!$util.isString(message.evaluation[i]))
        ...
        Resource.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Resource)
                return object;
            ...
            if (object.purpose) {
                if (!Array.isArray(object.purpose))
                    throw TypeError(".common.Resource.purpose: array expected");
                message.purpose = [];
                for (let i = 0; i < object.purpose.length; ++i)
                    message.purpose[i] = String(object.purpose[i]);
            }
            if (object.instructions) {
                if (!Array.isArray(object.instructions))
                    throw TypeError(".common.Resource.instructions: array expected");
                message.instructions = [];
                for (let i = 0; i < object.instructions.length; ++i)
                    message.instructions[i] = String(object.instructions[i]);
            }
            if (object.applicability) {
                if (!Array.isArray(object.applicability))
                    throw TypeError(".common.Resource.applicability: array expected");
                message.applicability = [];
                for (let i = 0; i < object.applicability.length; ++i)
                    message.applicability[i] = String(object.applicability[i]);
            }
            if (object.evaluation) {
                if (!Array.isArray(object.evaluation))
                    throw TypeError(".common.Resource.evaluation: array expected");
                message.evaluation = [];
                for (let i = 0; i < object.evaluation.length; ++i)
                    message.evaluation[i] = String(object.evaluation[i]);
            }
            if (object.tokens != null)
                message.tokens = object.tokens | 0;
        ...
        Resource.toObject = function toObject(message, options) {
            ...
            if (message.purpose && message.purpose.length) {
                object.purpose = [];
                for (let j = 0; j < message.purpose.length; ++j)
                    object.purpose[j] = message.purpose[j];
            }
            ...
            if (message.applicability && message.applicability.length) {
                object.applicability = [];
                for (let j = 0; j < message.applicability.length; ++j)
                    object.applicability[j] = message.applicability[j];
            }
            if (message.evaluation && message.evaluation.length) {
                object.evaluation = [];
                for (let j = 0; j < message.evaluation.length; ++j)
                    object.evaluation[j] = message.evaluation[j];
            }
            if (message.tokens != null && message.hasOwnProperty("tokens")) {
                object.tokens = message.tokens;
                if (options.oneofs)
                    object._tokens = "tokens";
            }
            if (message.magnitude != null && message.hasOwnProperty("magnitude")) {
                object.magnitude = message.magnitude;
                if (options.oneofs)
                    object._magnitude = "magnitude";
            }
            if (message.score != null && message.hasOwnProperty("score")) {
                object.score = options.json && !isFinite(message.score) ? String(message.score) : message.score;
                if (options.oneofs)
    ...
    common.ToolProp = (function() {
        ...
        ToolProp.fromObject = function fromObject(object) {
            if (object instanceof $root.common.ToolProp)
                return object;
    ...
    common.ToolParam = (function() {
        ...
        ToolParam.fromObject = function fromObject(object) {
            if (object instanceof $root.common.ToolParam)
                return object;
            ...
            if (object.properties) {
                ...
                for (let keys = Object.keys(object.properties), i = 0; i < keys.length; ++i) {
                    if (typeof object.properties[keys[i]] !== "object")
                        throw TypeError(".common.ToolParam.properties: object expected");
                    message.properties[keys[i]] = $root.common.ToolProp.fromObject(object.properties[keys[i]]);
                }
            }
            if (object.required) {
        ...
        ToolParam.toObject = function toObject(message, options) {
            ...
            if (message.properties && (keys2 = Object.keys(message.properties)).length) {
                ...
                for (let j = 0; j < keys2.length; ++j)
                    object.properties[keys2[j]] = $root.common.ToolProp.toObject(message.properties[keys2[j]], options);
            }
    ...
    common.ToolFunction = (function() {
        ...
        ToolFunction.fromObject = function fromObject(object) {
            if (object instanceof $root.common.ToolFunction)
                return object;
            ...
            if (object.parameters != null) {
                ...
                message.parameters = $root.common.ToolParam.fromObject(object.parameters);
            }
        ...
        ToolFunction.toObject = function toObject(message, options) {
            ...
            if (message.parameters != null && message.hasOwnProperty("parameters")) {
                object.parameters = $root.common.ToolParam.toObject(message.parameters, options);
                if (options.oneofs)
    ...
    common.Tool = (function() {
        ...
        Tool.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Tool)
                return object;
            ...
            if (object["function"] != null) {
                ...
                message["function"] = $root.common.ToolFunction.fromObject(object["function"]);
            }
            if (object.id != null)
                message.id = String(object.id);
            return message;
        ...
        Tool.toObject = function toObject(message, options) {
            ...
            if (message.type != null && message.hasOwnProperty("type"))
                object.type = message.type;
            if (message["function"] != null && message.hasOwnProperty("function"))
                object["function"] = $root.common.ToolFunction.toObject(message["function"], options);
            if (message.id != null && message.hasOwnProperty("id")) {
                object.id = message.id;
                if (options.oneofs)
                    object._id = "id";
    ...
    common.MessageV2 = (function() {
        ...
        MessageV2.verify = function verify(message) {
            ...
            if (message.tool_call_id != null && message.hasOwnProperty("tool_call_id")) {
        ...
        MessageV2.fromObject = function fromObject(object) {
            if (object instanceof $root.common.MessageV2)
                return object;
            ...
            if (object.tool_calls) {
                ...
                for (let i = 0; i < object.tool_calls.length; ++i) {
                    ...
                    message.tool_calls[i] = $root.common.Tool.fromObject(object.tool_calls[i]);
                }
            }
        ...
        MessageV2.toObject = function toObject(message, options) {
            ...
            if (message.tool_calls && message.tool_calls.length) {
                ...
                for (let j = 0; j < message.tool_calls.length; ++j)
                    object.tool_calls[j] = $root.common.Tool.toObject(message.tool_calls[j], options);
            }
            if (message.tool_call_id != null && message.hasOwnProperty("tool_call_id")) {
                object.tool_call_id = message.tool_call_id;
                if (options.oneofs)
                    object._tool_call_id = "tool_call_id";
            }
            return object;
        };
    ...
    common.Assistant = (function() {
         ...
         * @property {common.Resource|null} [meta] Assistant meta
         * @property {Array.<string>|null} [message] Assistant message
         */
         ...
         * @instance
         */
        Assistant.prototype.message = $util.emptyArray;
        ...
        Assistant.fromObject = function fromObject(object) {
            if (object instanceof $root.common.Assistant)
                return object;
            let message = new $root.common.Assistant();
            if (object.meta != null) {
                if (typeof object.meta !== "object")
                    throw TypeError(".common.Assistant.meta: object expected");
                message.meta = $root.common.Resource.fromObject(object.meta);
            }
            if (object.message) {
                if (!Array.isArray(object.message))
                    throw TypeError(".common.Assistant.message: array expected");
                message.message = [];
...
export const agent = $root.agent = (() => {
    ...
    agent.AgentRequest = (function() {
        ...
        AgentRequest.verify = function verify(message) {
            ...
            if (message.github_token != null && message.hasOwnProperty("github_token")) {
        ...
        AgentRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.agent.AgentRequest)
                return object;
        ...
        AgentRequest.toObject = function toObject(message, options) {
            ...
            if (message.session_id != null && message.hasOwnProperty("session_id")) {
                ...
                if (options.oneofs)
                    object._session_id = "session_id";
            }
            if (message.github_token != null && message.hasOwnProperty("github_token")) {
                object.github_token = message.github_token;
                if (options.oneofs)
                    object._github_token = "github_token";
            }
            return object;
        };
    ...
    agent.AgentResponse = (function() {
         ...
         * @instance
         */
        AgentResponse.prototype.created = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        AgentResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.agent.AgentResponse)
                return object;
            ...
            if (object.choices) {
                ...
                for (let i = 0; i < object.choices.length; ++i) {
                    ...
                    message.choices[i] = $root.common.Choice.fromObject(object.choices[i]);
                }
            }
        ...
        AgentResponse.toObject = function toObject(message, options) {
            ...
            if (message.choices && message.choices.length) {
                ...
                for (let j = 0; j < message.choices.length; ++j)
                    object.choices[j] = $root.common.Choice.toObject(message.choices[j], options);
            }
            if (message.usage != null && message.hasOwnProperty("usage"))
...
export const history = $root.history = (() => {
    ...
    history.GetHistoryRequest = (function() {
        ...
        GetHistoryRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.history.GetHistoryRequest)
                return object;
    ...
    history.GetHistoryResponse = (function() {
        ...
        GetHistoryResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.history.GetHistoryResponse)
                return object;
            let message = new $root.history.GetHistoryResponse();
            if (object.prompt != null) {
                if (typeof object.prompt !== "object")
                    throw TypeError(".history.GetHistoryResponse.prompt: object expected");
    ...
    history.UpdateHistoryRequest = (function() {
        ...
        UpdateHistoryRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.history.UpdateHistoryRequest)
                return object;
            ...
            if (object.prompt != null) {
                if (typeof object.prompt !== "object")
                    throw TypeError(".history.UpdateHistoryRequest.prompt: object expected");
                message.prompt = $root.common.Prompt.fromObject(object.prompt);
            }
            if (object.github_token != null)
                message.github_token = String(object.github_token);
    ...
    history.UpdateHistoryResponse = (function() {
        ...
        UpdateHistoryResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.history.UpdateHistoryResponse)
                return object;
...
export const llm = $root.llm = (() => {
    ...
    llm.EmbeddingsRequest = (function() {
        ...
        EmbeddingsRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.llm.EmbeddingsRequest)
                return object;
    ...
    llm.EmbeddingsResponse = (function() {
        ...
        EmbeddingsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.llm.EmbeddingsResponse)
                return object;
        ...
        EmbeddingsResponse.toObject = function toObject(message, options) {
            ...
            if (message.data && message.data.length) {
                ...
                for (let j = 0; j < message.data.length; ++j)
                    object.data[j] = $root.common.Embedding.toObject(message.data[j], options);
            }
            return object;
        };
    ...
    llm.CompletionsRequest = (function() {
        ...
        CompletionsRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.llm.CompletionsRequest)
                return object;
    ...
    llm.CompletionsResponse = (function() {
         ...
         * @instance
         */
        CompletionsResponse.prototype.created = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        CompletionsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.llm.CompletionsResponse)
                return object;
            ...
            if (object.choices) {
                ...
                for (let i = 0; i < object.choices.length; ++i) {
                    if (typeof object.choices[i] !== "object")
                        throw TypeError(".llm.CompletionsResponse.choices: object expected");
                    message.choices[i] = $root.common.Choice.fromObject(object.choices[i]);
                }
            }
            if (object.usage != null) {
...
export const text = $root.text = (() => {
    ...
    text.GetChunksRequest = (function() {
        ...
        GetChunksRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.text.GetChunksRequest)
                return object;
    ...
    text.GetChunksResponse = (function() {
        ...
        GetChunksResponse.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.chunks != null && message.hasOwnProperty("chunks")) {
                if (!$util.isObject(message.chunks))
                    return "chunks: object expected";
        ...
        GetChunksResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.text.GetChunksResponse)
                return object;
            ...
            if (object.chunks) {
                ...
                message.chunks = {};
                for (let keys = Object.keys(object.chunks), i = 0; i < keys.length; ++i) {
                    if (typeof object.chunks[keys[i]] !== "object")
                        throw TypeError(".text.GetChunksResponse.chunks: object expected");
                    message.chunks[keys[i]] = $root.common.Chunk.fromObject(object.chunks[keys[i]]);
                }
            }
            return message;
        };
        ...
        GetChunksResponse.toObject = function toObject(message, options) {
            ...
            if (message.chunks && (keys2 = Object.keys(message.chunks)).length) {
                object.chunks = {};
                for (let j = 0; j < keys2.length; ++j)
                    object.chunks[keys2[j]] = $root.common.Chunk.toObject(message.chunks[keys2[j]], options);
            }
            return object;
        };
...
export const vector = $root.vector = (() => {
    ...
    vector.QueryItemsRequest = (function() {
        ...
        QueryItemsRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.vector.QueryItemsRequest)
                return object;
    ...
    vector.QueryItemsResponse = (function() {
        ...
        QueryItemsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.vector.QueryItemsResponse)
                return object;
            ...
            if (object.results) {
                ...
                for (let i = 0; i < object.results.length; ++i) {
                    if (typeof object.results[i] !== "object")
                        throw TypeError(".vector.QueryItemsResponse.results: object expected");
                    message.results[i] = $root.common.Similarity.fromObject(object.results[i]);
                }
            }
            return message;
        };
        ...
        QueryItemsResponse.toObject = function toObject(message, options) {
            ...
            if (message.results && message.results.length) {
                ...
                for (let j = 0; j < message.results.length; ++j)
                    object.results[j] = $root.common.Similarity.toObject(message.results[j], options);
            }
            return object;
        };
