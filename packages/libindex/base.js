 ...
 * @property {() => import("@copilot-ld/libstorage").StorageInterface} storage - Returns the storage instance
...
export class IndexBase {
   ...
   * @returns {Promise<import("@copilot-ld/libtype").resource.Identifier[]>} Array of identifiers
   */
  async get(ids) {
