...
/**
 * AgentDrawer - A collapsible drawer chat interface component.
 *
 * Attributes:
 ...
 */
class AgentDrawer extends HTMLElement {
  /**
   *
   */
  /**
   * Create a new AgentDrawer component.
   */
  constructor() {
    super();
    ...
    // Load UI state
    this.collapsed = state.loadUIState("collapsed");
    this.expanded = state.loadUIState("expanded");
    this.loading = false;
  }
  ...
  toggleCollapsed() {
    ...
    state.saveUIState("collapsed", this.collapsed);
    this.setAttribute("data-collapsed", this.collapsed);
    this.render();
    if (!this.collapsed) {
      setTimeout(() => this.scrollToBottom(), 0);
  ...
  toggleExpanded() {
    ...
    state.saveUIState("expanded", this.expanded);
    this.setAttribute("data-expanded", this.expanded);
    this.render();
  }
...
customElements.define("agent-drawer", AgentDrawer);
