...
export class LlmService extends LlmBase {
   ...
   * @param {(token: string, model: string, baseUrl: string, embeddingBaseUrl: string|null, temperature: number) => import("@copilot-ld/libllm").LlmApi} [llmFn] - Factory function to create LLM client
   */
