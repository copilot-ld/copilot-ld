...
Agent profiles define the instructions, tools, and behavioral constraints that
guide agent execution. The following profiles were active during this scenario.
When analyzing failures, compare the agent's observed behavior against these
...
- **Passed:** {{#passed}}yes{{/passed}}{{^passed}}no{{/passed}}
- **Model:** {{{model}}}
- **Resource:** `{{{resource}}}`
