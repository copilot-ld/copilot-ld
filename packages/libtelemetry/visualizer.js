...
export class TraceVisualizer {
   ...
   * @param {import("@copilot-ld/libtype").trace.Span[]} allSpans - All spans in trace
   ...
   * @param {import("@copilot-ld/libtype").trace.Span} serverSpan - SERVER span
   ...
   * @param {import("@copilot-ld/libtype").trace.Span} span - Span to extract attributes from
