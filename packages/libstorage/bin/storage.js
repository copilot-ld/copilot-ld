...
import { Finder, waitFor } from "@copilot-ld/libutil";
...
Examples:
  storage upload                           # Upload all data/* dirs
  storage upload --prefix resources        # Upload specific prefix
  storage download                         # Download all remote prefixes
  storage list --prefix graphs             # List specific prefix
`);
  },
};
...
if (!command || command === "help" || values.help) {
  ...
  console.error('Run "storage help" for usage');
  process.exit(1);
}
