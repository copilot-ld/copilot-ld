  ...
  async createCompletions(params) {
    ...
    const messages = (params.messages || []).map((msg) => {
      ...
      if (msg.role === 'tool') {
        ...
        const toolCallId = msg.tool_call_id || msg.toolCallId || msg.id || (msg.descriptor && msg.descriptor.tool_call_id);
        return {
          role: 'tool',
    ...
    try {
      ...
      if (firstToolMsg) {
        ...
        console.debug('[copilot] Outbound tool message sample', JSON.stringify(firstToolMsg));
      }
    } catch {}
