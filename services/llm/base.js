...
export class LlmBase {
  ...
  async start() {
    ...
    const handlers = {};
    handlers.CreateEmbeddings = this.#createHandler("CreateEmbeddings");
    handlers.CreateCompletions = this.#createHandler("CreateCompletions");
   ...
   * @param {object} _request - EmbeddingRequest message
   ...
   * @param {object} _request - CompletionRequest message
   * @param {object} _metadata - gRPC metadata
   * @param {object} _call - gRPC call object
