...
import { HashClient } from "../generated/tools/hash/client.js";
...
describe("Generated client locations", () => {
   ...
   * - Exists at new path under generated/(services|tools)
   * - Extends base libservice Client (prototype chain)
  ...
  test("Hash tool client class shape", () => {
