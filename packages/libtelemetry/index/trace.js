...
export class TraceIndex extends BufferedIndex {
   ...
   * @returns {import("@copilot-ld/libtype").trace.Span[]} Array of spans from those traces
   */
   ...
   * @param {string} [trace_id] - Optional trace ID filter
   * @returns {import("@copilot-ld/libtype").trace.Span[]} Array of matching spans
   */
   ...
   * @param {Map<string, import("@copilot-ld/libtype").trace.Span[]>} traceGroups - Spans grouped by trace_id
