...
export namespace tool {
  ...
  class ListToolsRequest implements IListToolsRequest {
     ...
     * @param [properties] Properties to set
     */
    constructor(properties?: tool.IListToolsRequest);
  ...
  class ListToolsResponse implements IListToolsResponse {
     ...
     * @param [properties] Properties to set
     */
    constructor(properties?: tool.IListToolsResponse);
     ...
     */
    public static encode(
      message: tool.ListToolsResponse,
      writer?: $protobuf.Writer,
    ): $protobuf.Writer;
...
export namespace hash {
  ...
  /** Represents a HashRequest. */
  class HashRequest implements IHashRequest {
    /**
  ...
  /** Represents a HashResponse. */
  class HashResponse implements IHashResponse {
    /**
