...
describe("TraceVisualizer", () => {
  ...
  describe("visualize() - Single Trace", () => {
    ...
    test("generates Mermaid diagram for single trace", async () => {
      ...
      assert.ok(
        result.includes("agent->>+memory: ProcessRequest"),
        "Should show request",
      );
      assert.ok(
